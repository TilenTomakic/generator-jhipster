    ...
    sass: [
        {
            ...
            templates: [
                ...
                'content/scss/_app.scss',
                'content/scss/_mixins.scss',
                'content/scss/_theme.scss',
    ...
    image: [
        {
            ...
            templates: [
                ...
                { file: 'content/builder/handler-icons/any.svg', method: 'copy' },
                { file: 'content/builder/handler-icons/button-toggle-all-none-custom.svg', method: 'copy' },
                { file: 'content/builder/handler-icons/button-toggle-unknown-custom.svg', method: 'copy' },
                { file: 'content/builder/handler-icons/button-toggle.svg', method: 'copy' },
                { file: 'content/builder/handler-icons/code-editor.svg', method: 'copy' },
                { file: 'content/builder/handler-icons/color-picker.svg', method: 'copy' },
                { file: 'content/builder/handler-icons/component.svg', method: 'copy' },
                { file: 'content/builder/handler-icons/cost.svg', method: 'copy' },
                { file: 'content/builder/handler-icons/dropdown.svg', method: 'copy' },
                { file: 'content/builder/handler-icons/file-upload-token.svg', method: 'copy' },
                { file: 'content/builder/handler-icons/filter.svg', method: 'copy' },
                { file: 'content/builder/handler-icons/kanban.svg', method: 'copy' },
                { file: 'content/builder/handler-icons/payment-braintree.svg', method: 'copy' },
                { file: 'content/builder/handler-icons/paypal-checkout.svg', method: 'copy' },
                { file: 'content/builder/handler-icons/radio.svg', method: 'copy' },
                { file: 'content/builder/handler-icons/slider.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/D3.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/anchor.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/app-breadcrumbs.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/app-page-title.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/array-item-add.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/array-item-remove.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/badge.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/button.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/chartJS.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/col.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/custom-component.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/dialog-actions.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/dialog-content.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/div.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/drawer.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/expansion-panel.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/heading.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/hr.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/html.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/icon.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/image.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/list.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/menu-item.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/menu.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/order-summary.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/paragraph.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/powered-by.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/progress-bar.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/progress-tracker.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/prop-array.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/prop-table.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/prop.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/render-2d.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/row.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/section.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/span.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/stepper.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/sub.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/sup.svg', method: 'copy' },
                { file: 'content/builder/layout-icons/tab.svg', method: 'copy' },
                { file: 'content/builder/unknown.svg', method: 'copy' },
            ],
        },
    ],
    swagger: [
    ...
    angularAppJsf: [
        {
            ...
            templates: [
                // JSF START
                'jsf/api.service.ts',
                'jsf/jsf-entity.interface.ts',
                'jsf/jsf-themes/themes/default/base/_variables.scss',
                'jsf/jsf-themes/themes/default/base/builder/action-bar.scss',
                'jsf/jsf-themes/themes/default/base/builder/common.scss',
                'jsf/jsf-themes/themes/default/base/builder/drag-drop.scss',
                'jsf/jsf-themes/themes/default/base/builder/index.scss',
                'jsf/jsf-themes/themes/default/base/builder/items-layout/index.scss',
                'jsf/jsf-themes/themes/default/base/builder/items-layout/stepper.scss',
                'jsf/jsf-themes/themes/default/base/builder/layout-builder.scss',
                'jsf/jsf-themes/themes/default/base/builder/overlay/action-bar.scss',
                'jsf/jsf-themes/themes/default/base/builder/overlay/index.scss',
                'jsf/jsf-themes/themes/default/base/builder/toolbox.scss',
                'jsf/jsf-themes/themes/default/base/common/container/container.scss',
                'jsf/jsf-themes/themes/default/base/common/container/index.scss',
                'jsf/jsf-themes/themes/default/base/common/index.scss',
                'jsf/jsf-themes/themes/default/base/index.scss',
                'jsf/jsf-themes/themes/default/base/theme-default.breakpoints.ts',
                'jsf/jsf-themes/themes/default/base/theme-default.preferences.ts',
                'jsf/jsf-themes/themes/default/variants/default/default-default.component.scss',
                'jsf/jsf-themes/themes/default/variants/default/default-default.component.ts',
                'jsf/jsf-themes/themes/default/variants/default/default-default.module.ts',
                'jsf/jsf-themes/themes/shared/_functions.scss',
                'jsf/jsf-themes/themes/shared/_grid.scss',
                'jsf/jsf-themes/themes/shared/_material.scss',
                'jsf/jsf-themes/themes/shared/_reboot.scss',
                'jsf/jsf-themes/themes/shared/_typography.scss',
                'jsf/jsf-themes/themes/shared/_variables.scss',
                'jsf/jsf-themes/themes/shared/imports-core.scss',
                'jsf/jsf-themes/themes/shared/imports-reboot.scss',
                'jsf/jsf-themes/themes/shared/imports-theme.scss',
                'jsf/jsf-themes/themes/shared/index.scss',
                'jsf/jsf-themes/themes/shared/material/_button.scss',
                'jsf/jsf-themes/themes/shared/material/_card.scss',
                'jsf/jsf-themes/themes/shared/material/_checkbox.scss',
                'jsf/jsf-themes/themes/shared/material/_dialog.scss',
                'jsf/jsf-themes/themes/shared/material/_expansion-panel.scss',
                'jsf/jsf-themes/themes/shared/material/_form-field.scss',
                'jsf/jsf-themes/themes/shared/material/_list.scss',
                'jsf/jsf-themes/themes/shared/material/_menu.scss',
                'jsf/jsf-themes/themes/shared/material/_option.scss',
                'jsf/jsf-themes/themes/shared/material/_select.scss',
                'jsf/jsf-themes/themes/shared/material/_slider.scss',
                'jsf/jsf-themes/themes/shared/material/_stepper.scss',
                'jsf/jsf-themes/themes/shared/material/_table.scss',
                'jsf/jsf-themes/themes/shared/material/_tabset.scss',
                'jsf/jsf-themes/themes/shared/material/_toolbar.scss',
                'jsf/jsf-themes/themes/shared/material/index.scss',
                'jsf/jsf-themes/themes/shared/mixins/_box-shadow.scss',
                'jsf/jsf-themes/themes/shared/mixins/_breakpoints.scss',
                'jsf/jsf-themes/themes/shared/mixins/_float.scss',
                'jsf/jsf-themes/themes/shared/mixins/_grid-framework.scss',
                'jsf/jsf-themes/themes/shared/mixins/_grid.scss',
                'jsf/jsf-themes/themes/shared/mixins/_hover.scss',
                'jsf/jsf-themes/themes/shared/mixins/_lists.scss',
                'jsf/jsf-themes/themes/shared/mixins/_text.scss',
                'jsf/jsf-themes/themes/shared/mixins/index.scss',
                'jsf/jsf-themes/themes/shared/utilities/_align.scss',
                'jsf/jsf-themes/themes/shared/utilities/_borders.scss',
                'jsf/jsf-themes/themes/shared/utilities/_colors.scss',
                'jsf/jsf-themes/themes/shared/utilities/_cursor.scss',
                'jsf/jsf-themes/themes/shared/utilities/_display.scss',
                'jsf/jsf-themes/themes/shared/utilities/_flex.scss',
                'jsf/jsf-themes/themes/shared/utilities/_float.scss',
                'jsf/jsf-themes/themes/shared/utilities/_overflow.scss',
                'jsf/jsf-themes/themes/shared/utilities/_position.scss',
                'jsf/jsf-themes/themes/shared/utilities/_sizing.scss',
                'jsf/jsf-themes/themes/shared/utilities/_spacing.scss',
                'jsf/jsf-themes/themes/shared/utilities/_text.scss',
                'jsf/jsf-themes/themes/shared/utilities/index.scss',
                'jsf/theme/app-theme.component.html',
                'jsf/theme/app-theme.component.scss',
                'jsf/theme/app-theme.component.ts',
                // JSF END
            ],
        },
    ],
